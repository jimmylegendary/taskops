...
export function auditParsedWork(parsed, options = {}) {
  ...
  return {
    ...
    metrics: {
      ...
      supportingRunEowClosureCount: parsed.closure?.supportingRunEowClosureCount ?? 0,
      validSupportingRunEowClosureCount: parsed.closure?.validSupportingRunEowClosureCount ?? 0,
      invalidSupportingRunEowClosureCount: parsed.closure?.invalidSupportingRunEowClosureCount ?? 0,
      claimBearingRunEowClosureCount: parsed.closure?.claimBearingRunEowClosureCount ?? 0,
      policyApprovedClaimBearingRunEowClosureCount: parsed.closure?.policyApprovedClaimBearingRunEowClosureCount ?? 0,
    },
