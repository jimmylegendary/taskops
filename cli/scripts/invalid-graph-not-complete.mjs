...
const reviewReport = { decision: 'approved', mode: 'runner-managed', reviewedAcceptanceHash, reviewedResultHash };
const reviewReportHash = canonicalSha256(reviewReport);
const approvedFields = { approvedByReviewNodeId: 'run-node-review-01', approvedReviewMode: 'runner-managed', approvedReviewReportHash: reviewReportHash, reviewedAcceptanceHash, reviewedResultHash };
