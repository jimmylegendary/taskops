...
try {
  ...
  assert.equal(existsSync(join(workDir, 'runs', runResult.runId, 'eow', `eow-${runResult.actions[0].runNodeId}.md`)), false, 'runner partial must not create canonical run-node EoW');
