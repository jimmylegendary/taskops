...
const defs = [
  {
    ...
    maxSteps: 3, until: '2026-05-20T16:30:00+09:00', expectedStop: 'max_steps', expectedActions: ['execute','execute','execute'],
  },
  {
    ...
    maxSteps: 5, until: '2026-05-20T18:00:00+09:00', expectedStop: 'max_steps', expectedActions: ['execute','execute','execute','execute','execute'],
  },
  {
    ...
    maxSteps: 3, until: '2026-05-20T17:00:00+09:00', expectedStop: 'max_steps', expectedActions: ['decompose','decompose','decompose'],
  },
  {
    ...
    maxSteps: 4, until: '2026-05-20T19:00:00+09:00', expectedStop: 'max_steps', expectedActions: ['decompose','decompose','decompose','decompose'],
  },
  {
    ...
    maxSteps: 2, until: '2026-05-20T16:10:00+09:00', expectedStop: 'max_steps', expectedActions: ['explore','explore'],
  },
  {
    ...
    maxSteps: 3, until: '2026-05-20T20:00:00+09:00', expectedStop: 'max_steps', expectedActions: ['explore','explore','explore'],
  },
  {
    ...
    maxSteps: 10, until: '2026-05-21T09:00:00+09:00', expectedStop: 'waiting', expectedActions: [],
  },
  {
  ...
  },
  {
    ...
    maxSteps: 2, until: '2026-05-20T21:00:00+09:00', expectedStop: 'max_steps', expectedActions: ['execute','decompose'],
  },
  {
